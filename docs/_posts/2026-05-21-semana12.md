...
![full monaco]({{ site.baseurl }}/assets/images/JOSM_FULL_MONACO.png)
...
![monaco prix]({{ site.baseurl }}/assets/images/JOSM_MONACO_PRIX.png)
...
![monaco xodr]({{ site.baseurl }}/assets/images/XODR_SHAPE.png)
...
![elevarion xodr]({{ site.baseurl }}/assets/images/XODR_ELEV.png)

Video del resultado en CARLA, falta poner las texturas y los edificios:

[MONACO XODR](https://youtu.be/31gknweeBlo)
